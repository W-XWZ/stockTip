...
class get_show():
    def __init__(self):
        self.fx_pd=pd.read_csv('W:\\python-work\\realtime_stock-master\\fx1.csv',sep=',',converters={'code':str})
        self.industry_pd=pd.read_csv('W:\\python-work\\realtime_stock-master\\stock.csv',sep=',',converters={'code':str})
